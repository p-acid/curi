...
교육 및 활동 콘텐츠를 생성하고 관리할 수 있는 웹 애플리케이션입니다.

## 주요 기능

- **카테고리 기반 콘텐츠 생성**: 용돈벌기, 디지털, 그림, 글쓰기/독서, 건강/운동, 동기부여/성장, 취미힐링, 외국어 등 8개 카테고리 중 최대 2개 선택 가능
- **이미지 관리**: 대표 이미지 1장과 추가 이미지 최대 4장 업로드 (자동 정사각형 변환, IndexedDB 저장)
- **활동 방식 선택**: 온라인 또는 직접 만나기 옵션
- **다중 회차 관리**: 날짜, 시간, 활동 내용을 포함한 여러 회차 세션 추가 및 관리
- **실시간 Validation**: 제목, 시간, 날짜 등 모든 입력 값에 대한 검증
